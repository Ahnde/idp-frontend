	      ...
	      apiCheck: function apiCheck(check) {
	        return {
	          templateOptions: {
                ...
                postLabel: check.string.optional,
...
/***/ function(module, exports) {
	...
	module.exports = 	"<div>\
							<label for=\"{{id}}\" class=\"control-label form-label {{to.labelSrOnly ? 'sr-only' : ''}}\" ng-if=\"to.label\">\
								{{to.label}}\n{{to.required ? '*' : ''}}\
							</label>\
							<b class=\"control-label form-label\" ng-if='options.validators.isRequired'>*</b>\
							<div class=\"form-inline\">\
								<formly-transclude></formly-transclude>\
								<div class='validation validation-block' ng-if='options.validation.errorExistsAndShouldBeVisible' ng-messages='options.formControl.$error'>\
									<div ng-message='{{::name}}' ng-repeat='(name, message) in ::options.validation.messages'>\
										{{message(options.formControl.$viewValue, options.formControl.$modelValue, this)}}\
									</div>\
								</div>\
							</div>\
							<label for=\"{{id}}\" class=\"control-label form-postlabel {{to.labelSrOnly ? 'sr-only' : ''}}\" ng-if=\"to.postLabel\">\
								{{to.postLabel}}\n{{to.required ? '*' : ''}}\
							</label>\
							<div class=\"form-inline form-mui\">\
								<div class=\"form-inline control-label\" ng-if=\"to.missing\">\
									<label class=\"form-postcheckbox\" >M<label/>\
									<input type=\"checkbox\"/>\
								</div>\
								<div class=\"form-inline control-label\" ng-if=\"to.unobtainable\">\
									<label class=\"form-postcheckbox\" >U<label/>\
									<input type=\"checkbox\"/>\
								</div>\
								<div class=\"form-inline control-label\" ng-if=\"to.something_with_i\">\
									<label class=\"form-postcheckbox\" >I<label/>\
									<input type=\"checkbox\"/>\
								</div>\
							</div>\
						</div>"
